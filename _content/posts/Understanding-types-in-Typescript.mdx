...
summary: 'We go through the different Types in Typescript and show examples and their use.'
author: 'zakhargreaves'
---

# Introduction

Types are the number one reason why we use Typescript in the first place and there are lots them we can benefit from. 
